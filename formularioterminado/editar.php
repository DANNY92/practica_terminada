...
?>				<form action="editarguardados.php" method="post">
				...
				<p>Celuar <input type="text" name="celular" value="<?php echo $fila['celular'];?>"required/></p>
				<p>Domicilio <input type="text" name="domicilio" value="<?php echo $fila['domicilio'];?>"required/></p>
				<p>Colonia <input type="text" name="colonia" value="<?php echo $fila['colonia'];?>"required/></p>
                                <p>Codigo Postal <input type="text" name="cp" value="<?php echo $fila['cp'];?>"required/></p>
